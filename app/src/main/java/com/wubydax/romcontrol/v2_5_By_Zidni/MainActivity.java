...
import com.wubydax.romcontrol.v2_5_By_Zidni.utils.BackupRestoreIntentService;
import com.wubydax.romcontrol.v2_5_By_Zidni.utils.Constants;
import com.wubydax.romcontrol.v2_5_By_Zidni.utils.MyDialogFragment;
import com.wubydax.romcontrol.v2_5_By_Zidni.utils.SuTask;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id==R.id.tips){
            startActivity(new Intent(this, Tipps.class));
            return true;
        }
        if (id==R.id.themes){
        ...
        if (id==R.id.DpiActivity){
            ...
            mCustomTransaction.add(mSetDpiFragment, "dpi change");
